...
[![Build Status](https://travis-ci.org/trellis-ldp/trellis.png?branch=trellis-0.6.x)](https://travis-ci.org/trellis-ldp/trellis)
[![Build status](https://ci.appveyor.com/api/projects/status/nvdwx442663ib39d/branch/trellis-0.6.x?svg=true)](https://ci.appveyor.com/project/acoburn/trellis/branch/trellis-0.6.x)
[![Coverage Status](https://coveralls.io/repos/github/trellis-ldp/trellis/badge.svg?branch=trellis-0.6.x)](https://coveralls.io/github/trellis-ldp/trellis?branch=trellis-0.6.x)
