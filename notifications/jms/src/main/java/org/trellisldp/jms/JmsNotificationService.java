...
public class JmsNotificationService implements NotificationService {
    ...
    private static final Logger LOGGER = getLogger(JmsNotificationService.class);
    ...
    public void emit(final Notification notification) {
        ...
        try {
            final Message message = session.createTextMessage(serializer.serialize(notification));
