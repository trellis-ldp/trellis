...
import static org.trellisldp.common.Prefer.*;
...
class PreferTest {
    ...
    void testDefaultRepresentation() {
        assertTrue(HttpConstants.DEFAULT_REPRESENTATION.contains(LDP.PreferContainment));
        assertTrue(HttpConstants.DEFAULT_REPRESENTATION.contains(LDP.PreferMembership));
        assertTrue(HttpConstants.DEFAULT_REPRESENTATION.contains(Trellis.PreferUserManaged));
        assertTrue(HttpConstants.DEFAULT_REPRESENTATION.contains(Trellis.PreferServerManaged));
    }
